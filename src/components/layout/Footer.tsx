  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Technical Tutorials', href: '/tutorials' },
        { name: 'Product Webinars', href: '/webinars' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering enterprise digital transformation with cutting-edge cloud infrastructure
                and AI-driven solutions. Trusted by Fortune 500 companies worldwide for
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (800) ACME-TECH</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">Silicon Valley Tech Hub, CA 94105</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get enterprise tech insights and product updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
